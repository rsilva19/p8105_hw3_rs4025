...
The plot demonstrates that following vegetables and fruits (all in the department, produce), dairy is the most popular product type. This makes sense because produce and dairy products go bad more frequently and they are are a staple in a many kitches, so the number of items ordered is the largest. Although color does not help us identify every single aisle's department well, it helps us distinguish the top two departments (produce and dairy), which is interesting to see. 
